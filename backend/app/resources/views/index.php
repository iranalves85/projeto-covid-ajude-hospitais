...
<body>
    ...
    <section class="app-container" id="app">
        ...
        <div class="container">
            ...
            <div class="row border-bottom mb-2">
                <div class="col-md-4 font-size-8 mb-4 border-right">
                ...
                <div class="col-md-4 font-size-8 mb-4">
            ...
            <h2 class="text-center mt-5 mb-4">Solicitações Abertas</h2>
            ...
            <div class="row justify-content-between">                
                ...
                <div class="col-md-6 pr-4 pl-4 mb-3" v-for="item in items">
        ...
        <section class="mt-5 p-5 bg-light">
            <div class="container">
                <p class="text-center mb-5 font-weight-bolder">Empresas que apoiaram aparecem abaixo, <span>faça parte dessa rede do bem</span>!</p>
                <div class="row">
    ...
    <footer class="text-center p-4 bg-preto font-branca font-size-7 border-top">
